...
const Form = {
    ...
    validateFields() {
       ...
       if(
           description.trim() === "" || //trim faz uma limpeza de espacos vazios
           amount.trim() === "" ||
           date.trim() === "" ) {
